...
// var createBodies = module.exports.createBodies = function createBodies(templates, data, callback) {
//   var text, html;

//   function render(template, data, callback) {
//     var engine = _.find(engines, function(e) { return template.indexOf(e) !== -1; });
//     if(!engine) {
//       callback('Could not determine template engine from file: ' + template + '\nMake sure the name of the engine is part of the filename or path.');
//     }
...
//         return callback();
//       }
//       render(templates.text, data, callback);
//     },
//     'html': function(callback) {
//       if(!templates.html) {
//         return callback();
//       }
//       render(templates.html, data, callback);
//     }
